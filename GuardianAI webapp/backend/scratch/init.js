    ...
    "paths": {
      ...
      "/v1/document/generated-files/{filename}": {
        "get": {
          ...
          "description": "Download a file generated by an agent skill (e.g., PDF, DOCX, XLSX, PPTX). The filename is returned in the `outputs` array of a chat response when an agent generates a file. Use the `storageFilename` value from that response to download the file.",
          "parameters": [
            {
              "name": "filename",
              "in": "path",
      ...
      "/v1/transcription/transcribe": {
        "post": {
          ...
          "description": "Transcribe an audio or video file using the configured transcription provider (Meeting Assistant engine). Returns the transcription JSON without saving a meeting record.",
          "parameters": [],
          "responses": {
            "200": {
                ...
                "schema": {
                  ...
                  "properties": {
                    "audio": {
                      "type": "string",
                      "format": "binary",
                      "description": "Audio or video file to transcribe (any supported audio or video format)"
                    }
                  },
                  "required": [
                    "audio"
